...
% Trying to solve the problem that a cventry usually leaves lots of space on a page.
% From: http://tex.stackexchange.com/questions/46123/page-breaks-within-moderncv
...
% To make the font size of the cvitemize the same, I have to add the command: before*=\small
% Source: http://tex.stackexchange.com/questions/100524/how-to-set-the-different-fontsize-according-to-different-levels-in-an-enumitem-l
\newlist{cvitemize}{itemize}{1}
\setlist[cvitemize]{label=\labelitemi,%
leftmargin=\hintscolumnwidth+\separatorcolumnwidth+\labelwidth+\labelsep, before*=\small}



\name{Shih-Kai}{Lin}
\title{Postdoctoral Researcher}
\address{2247 Oakridge Dr Apt 1}{Aurora, IL, 60502}
\phone[mobile]{+1~(864)~349~5588}
%\phone[fixed]{+2~(345)~678~901}
%\phone[fax]{+3~(456)~789~012}
\email{Shihkai.Lin@colostate.edu}
...
\cventry{Sept. 2014}{Doctor of Philosophy in Physics}{University of Houston}{Houston, TX}{}{}%{\textit{GPA: 3.867/4.0}}{}
...
\cventry{2014--present}{Postdoctoral Researcher}{Colorado State University}{Fort Collins, CO}{}{Member of the NOvA and the 35-ton prototype collaboration at Fermi National Accelerator Laboratory.
\begin{itemize}
  \item Software manager for the NOvA Data Driven Trigger (DDT) system, a subsystem of the NOvA Data Acquisition (DAQ) system.
  \item Measuring muon antineutrino charged-current inclusive cross section with the NOvA near detector.
  \item Developed the control application for the LBNE calibration module for photon detector, which was used in 35-ton prototype's data taking.
  \item Photon detector R\&D and performance study.
\end{itemize}}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% UH era
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\cventry{2009--2014}{Research Assistant}{University of Houston}{Houston, TX}{}{Member of particle physics group and Daya Bay Reactor Neutrino Experiment. Actively participated in the muon detector system QC/QA, installation, commissioning, operation, and data analysis.%\newline{}%
...
\cvitem{Nov 2016}{Fermi National Accelerator Laboratory \href{http://npc.fnal.gov/fall-2016-npc-scholars/}{Fall 2016 NPC Scholars}}
\cvitem{Nov 2015}{The 2016 Breakthrough Prize in Fundamental Physics}
...
\cvitem{2017}{(NOvA Collaboration), ``Constraints on oscillation parameters from $\nu_e$ appearance and $\nu_\mu$ disappearance in NOvA'', \textit{Physical Review Letters} 118 (23), 231801}

\cvitem{2017}{(NOvA Collaboration), ``Measurement of the Neutrino Mixing Angle $\theta_{23}$ in NOvA'', \textit{Physical Review Letters} 118 (15), 151802}

\cvitem{2017}{(Daya Bay Collaboration), ``Measurement of electron antineutrino oscillation based on 1230 days of operation of the Daya Bay experiment'', \textit{Physical Review D} 95 (7), 072006}

\cvitem{2017}{(Daya Bay Collaboration), ``Improved measurement of the reactor antineutrino flux and spectrum at Daya Bay'', \textit{Chinese Physics C} 41 (1), 013002}

\cvitem{2016}{(Daya Bay Collaboration and MINOS Collaboration), ``Limits on active to sterile neutrino oscillations from disappearance searches in the MINOS, Daya Bay, and Bugey-3 experiments'', \textit{Physical Review Letters} 117 (15), 151801}

\cvitem{2016}{(Daya Bay Collaboration), ``Improved search for a light sterile neutrino with the full configuration of the Daya Bay experiment'', \textit{Physical Review Letters} 117 (15), 151802}

\cvitem{2016}{(Daya Bay Collaboration), ``New measurement of $\theta_{13}$ via neutron capture on hydrogen at Daya Bay'', \textit{Physical Review D} 93 (7), 072011}

\cvitem{2016}{(Daya Bay Collaboration), ``The detector system of the Daya Bay reactor neutrino experiment'', \textit{Nuclear Instruments and Methods in Physics Research A} 811 (2016) 133-161}

\cvitem{2016}{(Daya Bay Collaboration), ``Measurement of the Reactor Antineutrino Flux and Spectrum at Daya Bay'', \textit{Phys. Rev. Lett.} 116, 061801 (2016)}

\cvitem{2015}{(Daya Bay Collaboration), ``New Measurement of Antineutrino Oscillation with the Full Detector Configuration at Daya Bay'', \textit{Phys. Rev. Lett.} 115, 111802 (2015)}

\cvitem{2015}{(Ken Chow, John Cummings, Emily Edwards, William Edwards, Ry Ely, Matthew Hoff, Logan Lebanowski , Bo Li, Piyi Li, \underline{\textbf{\emph{Shih-Kai Lin}}}, Dawei Liu, Jinchang Liu, Kam-Biu Luk, Jiayuan Miao, Jim Napolitano, Juan Pedro Ochoa-Ricoux, Jen-Chieh Peng, Ming Qi, Herbert Steiner, Paul Stoler, Mary Stuart, Lingyu Wang, Changgen Yang, Weili Zhong), ``Waterproofed photomultiplier tube assemblies for the Daya Bay reactor neutrino experiment'', \textit{Nuclear Instruments and Methods in Physics Research A} 794 (2015) 25-32}

\cvitem{2015}{(Daya Bay Collaboration), ``The muon system of the Daya Bay Reactor antineutrino experiment'', \textit{Nuclear Instruments and Methods in Physics Research A} 773 (2015) 8-20}
